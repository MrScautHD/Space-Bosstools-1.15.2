...
public class IceshardItem extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:iceshard")
	public static final Item block = null;
	public IceshardItem(BossToolsModElements instance) {
		super(instance, 24);
	}
