...
public class FlagPurpleBlock extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:flag_purple")
	public static final Block block = null;
	public FlagPurpleBlock(BossToolsModElements instance) {
		super(instance, 74);
	}
