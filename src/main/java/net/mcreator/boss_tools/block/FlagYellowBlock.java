...
public class FlagYellowBlock extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:flag_yellow")
	public static final Block block = null;
	public FlagYellowBlock(BossToolsModElements instance) {
		super(instance, 76);
	}
