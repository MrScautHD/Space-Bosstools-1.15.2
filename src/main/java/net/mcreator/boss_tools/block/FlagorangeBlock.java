...
public class FlagorangeBlock extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:flagorange")
	public static final Block block = null;
	public FlagorangeBlock(BossToolsModElements instance) {
		super(instance, 72);
	}
