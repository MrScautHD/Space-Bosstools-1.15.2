...
public class FlagRedBlock extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:flag_red")
	public static final Block block = null;
	public FlagRedBlock(BossToolsModElements instance) {
		super(instance, 75);
	}
