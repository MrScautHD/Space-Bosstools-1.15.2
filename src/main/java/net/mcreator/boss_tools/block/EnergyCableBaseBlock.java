...
import net.mcreator.boss_tools.procedures.EnergyCableBaseUpdateTickProcedure;
...
public class EnergyCableBaseBlock extends BossToolsModElements.ModElement {
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("energy_cable_base"));
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.STONE).hardnessAndResistance(0.5f, 10f).lightValue(0).notSolid());
			setRegistryName("energy_cable_base");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("energy_cable_base");
		}
