...
import net.mcreator.boss_tools.itemgroup.SpaceBosstoolsFlagsItemGroup;
...
public class FlaglightBlueBlock extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:flaglight_blue")
	public static final Block block = null;
	public FlaglightBlueBlock(BossToolsModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.CARPET).sound(SoundType.STONE).hardnessAndResistance(1f, 10f).lightValue(1).notSolid());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("flaglight_blue");
		}
