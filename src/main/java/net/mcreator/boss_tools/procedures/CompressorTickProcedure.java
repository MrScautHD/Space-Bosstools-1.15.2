	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				BossToolsMod.LOGGER.warn("Failed to load dependency x for procedure CompressorTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				BossToolsMod.LOGGER.warn("Failed to load dependency y for procedure CompressorTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				BossToolsMod.LOGGER.warn("Failed to load dependency z for procedure CompressorTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				BossToolsMod.LOGGER.warn("Failed to load dependency world for procedure CompressorTick!");
			return;
		}
		...
		if (((ItemTags.getCollection().getOrCreate(new ResourceLocation(("forge:ingots/steel").toLowerCase(java.util.Locale.ENGLISH)))
				.contains((new Object() {
		...
		} else if (((ItemTags.getCollection().getOrCreate(new ResourceLocation(("forge:ingots/desh").toLowerCase(java.util.Locale.ENGLISH)))
				.contains((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
						TileEntity _ent = world.getTileEntity(pos);
		...
		} else if (((ItemTags.getCollection().getOrCreate(new ResourceLocation(("forge:ingots/silicon").toLowerCase(java.util.Locale.ENGLISH)))
				.contains((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
						TileEntity _ent = world.getTileEntity(pos);
			...
			if (((new Object() {
				...
				if ((((ItemTags.getCollection().getOrCreate(new ResourceLocation(("forge:ingots/steel").toLowerCase(java.util.Locale.ENGLISH)))
					...
					if ((((new Object() {
						...
						.getOrCreate(new ResourceLocation(("forge:ingots/silicon").toLowerCase(java.util.Locale.ENGLISH))).contains((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
								if (_ent != null) {
		...
		if ((((ItemTags.getCollection().getOrCreate(new ResourceLocation(("forge:ingots/steel").toLowerCase(java.util.Locale.ENGLISH)))
				.contains((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						.getOrCreate(new ResourceLocation(("forge:ingots/desh").toLowerCase(java.util.Locale.ENGLISH))).contains((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
								if (_ent != null) {
						...
						|| (ItemTags.getCollection().getOrCreate(new ResourceLocation(("forge:ingots/silicon").toLowerCase(java.util.Locale.ENGLISH)))
								.contains((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
								...
								}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem())))) == (false))) {
			if (!world.getWorld().isRemote) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
		...
		if (((((ItemTags.getCollection().getOrCreate(new ResourceLocation(("forge:ingots/steel").toLowerCase(java.util.Locale.ENGLISH)))
				.contains((new Object() {
					...
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						.getItem()))
				|| (((ItemTags.getCollection().getOrCreate(new ResourceLocation(("forge:ingots/steel").toLowerCase(java.util.Locale.ENGLISH)))
						.contains((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
						...
						|| (((ItemTags.getCollection().getOrCreate(new ResourceLocation(("forge:ingots/desh").toLowerCase(java.util.Locale.ENGLISH)))
								.contains((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
								...
								|| (((ItemTags.getCollection()
										.getOrCreate(new ResourceLocation(("forge:ingots/desh").toLowerCase(java.util.Locale.ENGLISH)))
										.contains((new Object() {
											public ItemStack getItemStack(BlockPos pos, int sltid) {
												AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
												TileEntity _ent = world.getTileEntity(pos);
											...
											public ItemStack getItemStack(BlockPos pos, int sltid) {
												...
												.getItem() == new ItemStack(CompressedsiliconItem.block, (int) (1)).getItem()))
										|| (((ItemTags.getCollection()
												.getOrCreate(new ResourceLocation(("forge:ingots/silicon").toLowerCase(java.util.Locale.ENGLISH)))
												.contains((new Object() {
													public ItemStack getItemStack(BlockPos pos, int sltid) {
														AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
														TileEntity _ent = world.getTileEntity(pos);
												...
												|| ((ItemTags.getCollection()
														...
														&& ((new Object() {
															public ItemStack getItemStack(BlockPos pos, int sltid) {
																...
																.getItem() == new ItemStack(CompressedTinItem.block, (int) (1))
																		.getItem()))))))) == (true))) {
			if (!world.getWorld().isRemote) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
			...
			if (((new Object() {
				...
				if (((new Object() {
					...
					if (((new Object() {
						...
						if (((ItemTags.getCollection().getOrCreate(new ResourceLocation(("forge:ingots/desh").toLowerCase(java.util.Locale.ENGLISH)))
								.contains((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
