...
import net.mcreator.boss_tools.procedures.RocketY4Procedure;
...
public class RocketOverlyY4Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY4Overlay(BossToolsModElements instance) {
		super(instance, 598);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY4Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
