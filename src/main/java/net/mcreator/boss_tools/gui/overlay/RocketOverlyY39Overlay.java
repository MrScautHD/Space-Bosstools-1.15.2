...
import net.mcreator.boss_tools.procedures.RocketY39Procedure;
...
public class RocketOverlyY39Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY39Overlay(BossToolsModElements instance) {
		super(instance, 638);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY39Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
