...
import net.mcreator.boss_tools.procedures.RocketY35Procedure;
...
public class RocketOverlyY35Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY35Overlay(BossToolsModElements instance) {
		super(instance, 634);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY35Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
