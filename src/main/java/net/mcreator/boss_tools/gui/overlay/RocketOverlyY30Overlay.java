...
import net.mcreator.boss_tools.procedures.RocketY30Procedure;
...
public class RocketOverlyY30Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY30Overlay(BossToolsModElements instance) {
		super(instance, 629);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY30Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
