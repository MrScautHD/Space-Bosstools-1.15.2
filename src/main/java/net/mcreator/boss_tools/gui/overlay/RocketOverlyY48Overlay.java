...
import net.mcreator.boss_tools.procedures.RocketY48Procedure;
...
public class RocketOverlyY48Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY48Overlay(BossToolsModElements instance) {
		super(instance, 647);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY48Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
