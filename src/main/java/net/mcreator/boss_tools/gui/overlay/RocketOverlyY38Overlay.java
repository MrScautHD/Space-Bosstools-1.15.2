...
import net.mcreator.boss_tools.procedures.RocketY38Procedure;
...
public class RocketOverlyY38Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY38Overlay(BossToolsModElements instance) {
		super(instance, 637);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY38Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
