...
import net.mcreator.boss_tools.procedures.RocketY24Procedure;
...
public class RocketOverlyY24Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY24Overlay(BossToolsModElements instance) {
		super(instance, 623);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY24Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
