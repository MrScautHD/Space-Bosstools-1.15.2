...
import net.mcreator.boss_tools.procedures.Rockety1Procedure;
...
public class RocketOverlyY1Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY1Overlay(BossToolsModElements instance) {
		super(instance, 595);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (Rockety1Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
