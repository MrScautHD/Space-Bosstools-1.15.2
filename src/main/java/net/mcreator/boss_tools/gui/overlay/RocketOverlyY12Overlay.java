...
import net.mcreator.boss_tools.procedures.RocketY12Procedure;
...
public class RocketOverlyY12Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY12Overlay(BossToolsModElements instance) {
		super(instance, 606);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY12Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
