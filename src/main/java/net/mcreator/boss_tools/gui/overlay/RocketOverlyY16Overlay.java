...
import net.mcreator.boss_tools.procedures.RocketY16Procedure;
...
public class RocketOverlyY16Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY16Overlay(BossToolsModElements instance) {
		super(instance, 615);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY16Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
