...
import net.mcreator.boss_tools.procedures.RocketY19Procedure;
...
public class RocketOverlyY19Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY19Overlay(BossToolsModElements instance) {
		super(instance, 618);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY19Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
