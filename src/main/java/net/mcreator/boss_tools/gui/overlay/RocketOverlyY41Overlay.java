...
import net.mcreator.boss_tools.procedures.RocketY41Procedure;
...
public class RocketOverlyY41Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY41Overlay(BossToolsModElements instance) {
		super(instance, 640);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY41Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
