...
import net.mcreator.boss_tools.procedures.RocketY23Procedure;
...
public class RocketOverlyY23Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY23Overlay(BossToolsModElements instance) {
		super(instance, 622);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY23Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
