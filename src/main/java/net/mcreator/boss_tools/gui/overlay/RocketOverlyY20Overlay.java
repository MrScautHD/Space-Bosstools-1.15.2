...
import net.mcreator.boss_tools.procedures.RocketY20Procedure;
...
public class RocketOverlyY20Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY20Overlay(BossToolsModElements instance) {
		super(instance, 619);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY20Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
