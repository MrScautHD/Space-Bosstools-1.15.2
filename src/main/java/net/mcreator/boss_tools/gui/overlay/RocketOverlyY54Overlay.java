...
import net.mcreator.boss_tools.procedures.RocketY54Procedure;
...
public class RocketOverlyY54Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY54Overlay(BossToolsModElements instance) {
		super(instance, 653);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY54Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
