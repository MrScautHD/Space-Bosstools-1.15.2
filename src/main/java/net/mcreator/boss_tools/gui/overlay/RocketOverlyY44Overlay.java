...
import net.mcreator.boss_tools.procedures.RocketY44Procedure;
...
public class RocketOverlyY44Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY44Overlay(BossToolsModElements instance) {
		super(instance, 643);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY44Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
