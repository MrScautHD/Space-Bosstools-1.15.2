...
import net.mcreator.boss_tools.procedures.RocketY6Procedure;
...
public class RocketOverlyY6Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY6Overlay(BossToolsModElements instance) {
		super(instance, 600);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY6Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
