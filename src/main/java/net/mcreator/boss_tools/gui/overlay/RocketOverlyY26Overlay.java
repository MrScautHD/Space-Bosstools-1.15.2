...
import net.mcreator.boss_tools.procedures.RocketY26Procedure;
...
public class RocketOverlyY26Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY26Overlay(BossToolsModElements instance) {
		super(instance, 625);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY26Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
