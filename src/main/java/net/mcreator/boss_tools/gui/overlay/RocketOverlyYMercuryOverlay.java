...
import net.mcreator.boss_tools.procedures.RocketOverlyYMercurymainProcedure;
...
public class RocketOverlyYMercuryOverlay extends BossToolsModElements.ModElement {
	public RocketOverlyYMercuryOverlay(BossToolsModElements instance) {
		super(instance, 502);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketOverlyYMercurymainProcedure.executeProcedure(ImmutableMap.of("entity", entity, "world", world))) {
