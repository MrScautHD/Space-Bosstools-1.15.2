...
import net.mcreator.boss_tools.procedures.RocketY21Procedure;
...
public class RocketOverlyY21Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY21Overlay(BossToolsModElements instance) {
		super(instance, 620);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY21Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
