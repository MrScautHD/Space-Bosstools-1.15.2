...
import net.mcreator.boss_tools.procedures.RocketY42Procedure;
...
public class RocketOverlyY42Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY42Overlay(BossToolsModElements instance) {
		super(instance, 641);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY42Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
