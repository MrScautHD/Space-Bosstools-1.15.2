...
import net.mcreator.boss_tools.procedures.RocketY31Procedure;
...
public class RocketOverlyY31Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY31Overlay(BossToolsModElements instance) {
		super(instance, 630);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY31Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
