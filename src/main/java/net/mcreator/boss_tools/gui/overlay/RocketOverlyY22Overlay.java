...
import net.mcreator.boss_tools.procedures.RocketY22Procedure;
...
public class RocketOverlyY22Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY22Overlay(BossToolsModElements instance) {
		super(instance, 621);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY22Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
