...
import net.mcreator.boss_tools.procedures.RocketY45Procedure;
...
public class RocketOverlyY45Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY45Overlay(BossToolsModElements instance) {
		super(instance, 644);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY45Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
