...
import net.mcreator.boss_tools.procedures.RocketY13Procedure;
...
public class RocketOverlyY13Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY13Overlay(BossToolsModElements instance) {
		super(instance, 607);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY13Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
