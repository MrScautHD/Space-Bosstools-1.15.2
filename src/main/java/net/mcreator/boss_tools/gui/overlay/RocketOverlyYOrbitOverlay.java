...
import net.mcreator.boss_tools.procedures.RocketOverlyOrbitmainProcedure;
...
public class RocketOverlyYOrbitOverlay extends BossToolsModElements.ModElement {
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketOverlyOrbitmainProcedure.executeProcedure(ImmutableMap.of("entity", entity, "world", world))) {
