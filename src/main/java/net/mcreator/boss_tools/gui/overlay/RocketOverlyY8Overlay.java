...
import net.mcreator.boss_tools.procedures.RocketY8Procedure;
...
public class RocketOverlyY8Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY8Overlay(BossToolsModElements instance) {
		super(instance, 602);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY8Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
