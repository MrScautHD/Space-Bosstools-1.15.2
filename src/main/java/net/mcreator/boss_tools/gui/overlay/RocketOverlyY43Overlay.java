...
import net.mcreator.boss_tools.procedures.RocketY43Procedure;
...
public class RocketOverlyY43Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY43Overlay(BossToolsModElements instance) {
		super(instance, 642);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY43Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
