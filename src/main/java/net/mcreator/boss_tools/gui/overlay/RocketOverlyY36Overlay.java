...
import net.mcreator.boss_tools.procedures.RocketY36Procedure;
...
public class RocketOverlyY36Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY36Overlay(BossToolsModElements instance) {
		super(instance, 635);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY36Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
