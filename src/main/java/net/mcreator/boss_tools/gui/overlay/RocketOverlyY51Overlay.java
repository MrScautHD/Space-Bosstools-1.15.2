...
import net.mcreator.boss_tools.procedures.RocketY51Procedure;
...
public class RocketOverlyY51Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY51Overlay(BossToolsModElements instance) {
		super(instance, 650);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY51Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
