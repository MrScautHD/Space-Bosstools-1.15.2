...
import net.mcreator.boss_tools.procedures.RocketY17Procedure;
...
public class RocketOverlyY17Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY17Overlay(BossToolsModElements instance) {
		super(instance, 616);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY17Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
