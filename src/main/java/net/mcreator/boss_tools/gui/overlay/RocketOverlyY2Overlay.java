...
import net.mcreator.boss_tools.procedures.Rockety2Procedure;
...
public class RocketOverlyY2Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY2Overlay(BossToolsModElements instance) {
		super(instance, 596);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (Rockety2Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
