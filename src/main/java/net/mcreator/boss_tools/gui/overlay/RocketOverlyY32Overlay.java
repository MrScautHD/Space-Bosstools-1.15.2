...
import net.mcreator.boss_tools.procedures.RocketY32Procedure;
...
public class RocketOverlyY32Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY32Overlay(BossToolsModElements instance) {
		super(instance, 631);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY32Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
