...
import net.mcreator.boss_tools.procedures.RocketY40Procedure;
...
public class RocketOverlyY40Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY40Overlay(BossToolsModElements instance) {
		super(instance, 639);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY40Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
