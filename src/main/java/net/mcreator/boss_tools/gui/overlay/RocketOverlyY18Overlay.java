...
import net.mcreator.boss_tools.procedures.RocketY18Procedure;
...
public class RocketOverlyY18Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY18Overlay(BossToolsModElements instance) {
		super(instance, 617);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY18Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
