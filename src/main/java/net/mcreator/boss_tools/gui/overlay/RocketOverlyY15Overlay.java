...
import net.mcreator.boss_tools.procedures.RocketY15Procedure;
...
public class RocketOverlyY15Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY15Overlay(BossToolsModElements instance) {
		super(instance, 609);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY15Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
