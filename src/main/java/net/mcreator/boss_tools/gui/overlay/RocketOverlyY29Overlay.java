...
import net.mcreator.boss_tools.procedures.RocketY29Procedure;
...
public class RocketOverlyY29Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY29Overlay(BossToolsModElements instance) {
		super(instance, 628);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY29Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
