...
import net.mcreator.boss_tools.procedures.RocketY53Procedure;
...
public class RocketOverlyY53Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY53Overlay(BossToolsModElements instance) {
		super(instance, 652);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY53Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
