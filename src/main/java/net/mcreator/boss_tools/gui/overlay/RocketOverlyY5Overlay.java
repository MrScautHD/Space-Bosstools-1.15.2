...
import net.mcreator.boss_tools.procedures.RocketY5Procedure;
...
public class RocketOverlyY5Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY5Overlay(BossToolsModElements instance) {
		super(instance, 599);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY5Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
