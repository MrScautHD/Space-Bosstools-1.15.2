...
import net.mcreator.boss_tools.procedures.RocketY56Procedure;
...
public class RocketOverlyY56Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY56Overlay(BossToolsModElements instance) {
		super(instance, 655);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY56Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
