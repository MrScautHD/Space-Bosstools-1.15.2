...
import net.mcreator.boss_tools.procedures.RocketOverlyYDisplayOverlayIngameProcedure;
...
public class RocketOverlyYOverlay extends BossToolsModElements.ModElement {
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketOverlyYDisplayOverlayIngameProcedure.executeProcedure(ImmutableMap.of("entity", entity, "world", world))) {
