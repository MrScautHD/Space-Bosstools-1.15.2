...
import net.mcreator.boss_tools.procedures.RocketY27Procedure;
...
public class RocketOverlyY27Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY27Overlay(BossToolsModElements instance) {
		super(instance, 626);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY27Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
