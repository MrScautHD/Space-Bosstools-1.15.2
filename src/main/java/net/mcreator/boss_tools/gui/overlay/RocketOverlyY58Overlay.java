...
import net.mcreator.boss_tools.procedures.RocketY58Procedure;
...
public class RocketOverlyY58Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY58Overlay(BossToolsModElements instance) {
		super(instance, 657);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY58Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
