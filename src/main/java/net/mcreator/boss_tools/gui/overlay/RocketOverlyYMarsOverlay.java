...
import net.mcreator.boss_tools.procedures.RocketOverlyYMarsmainProcedure;
...
public class RocketOverlyYMarsOverlay extends BossToolsModElements.ModElement {
	public RocketOverlyYMarsOverlay(BossToolsModElements instance) {
		super(instance, 501);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketOverlyYMarsmainProcedure.executeProcedure(ImmutableMap.of("entity", entity, "world", world))) {
