...
import net.mcreator.boss_tools.procedures.RocketY57Procedure;
...
public class RocketOverlyY57Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY57Overlay(BossToolsModElements instance) {
		super(instance, 656);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY57Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
