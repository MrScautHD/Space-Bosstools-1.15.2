...
import net.mcreator.boss_tools.procedures.RocketY55Procedure;
...
public class RocketOverlyY55Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY55Overlay(BossToolsModElements instance) {
		super(instance, 654);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY55Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
