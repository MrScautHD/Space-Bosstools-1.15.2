...
import net.mcreator.boss_tools.procedures.RocketY49Procedure;
...
public class RocketOverlyY49Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY49Overlay(BossToolsModElements instance) {
		super(instance, 648);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY49Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
