...
import net.mcreator.boss_tools.procedures.RocketY28Procedure;
...
public class RocketOverlyY28Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY28Overlay(BossToolsModElements instance) {
		super(instance, 627);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY28Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
