...
import net.mcreator.boss_tools.procedures.RocketY46Procedure;
...
public class RocketOverlyY46Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY46Overlay(BossToolsModElements instance) {
		super(instance, 645);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY46Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
