...
import net.mcreator.boss_tools.procedures.RocketY34Procedure;
...
public class RocketOverlyY34Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY34Overlay(BossToolsModElements instance) {
		super(instance, 633);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY34Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
