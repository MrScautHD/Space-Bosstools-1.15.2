...
import net.mcreator.boss_tools.procedures.RocketY52Procedure;
...
public class RocketOverlyY52Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY52Overlay(BossToolsModElements instance) {
		super(instance, 651);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY52Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
