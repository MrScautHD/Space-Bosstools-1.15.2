...
import net.mcreator.boss_tools.procedures.RocketOverlyYMoonmainProcedure;
...
public class RocketOverlyYMoonOverlay extends BossToolsModElements.ModElement {
	public RocketOverlyYMoonOverlay(BossToolsModElements instance) {
		super(instance, 500);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketOverlyYMoonmainProcedure.executeProcedure(ImmutableMap.of("entity", entity, "world", world))) {
