...
import net.mcreator.boss_tools.procedures.RocketY3Procedure;
...
public class RocketOverlyY3Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY3Overlay(BossToolsModElements instance) {
		super(instance, 597);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY3Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
