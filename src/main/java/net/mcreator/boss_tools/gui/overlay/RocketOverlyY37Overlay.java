...
import net.mcreator.boss_tools.procedures.RocketY37Procedure;
...
public class RocketOverlyY37Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY37Overlay(BossToolsModElements instance) {
		super(instance, 636);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY37Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
