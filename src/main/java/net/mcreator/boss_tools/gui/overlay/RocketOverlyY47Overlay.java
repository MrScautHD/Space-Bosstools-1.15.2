...
import net.mcreator.boss_tools.procedures.RocketY47Procedure;
...
public class RocketOverlyY47Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY47Overlay(BossToolsModElements instance) {
		super(instance, 646);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY47Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
