...
import net.mcreator.boss_tools.procedures.RocketY14Procedure;
...
public class RocketOverlyY14Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY14Overlay(BossToolsModElements instance) {
		super(instance, 608);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY14Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
