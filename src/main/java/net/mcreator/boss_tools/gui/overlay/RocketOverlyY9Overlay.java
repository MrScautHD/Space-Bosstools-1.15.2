...
import net.mcreator.boss_tools.procedures.RocketY9Procedure;
...
public class RocketOverlyY9Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY9Overlay(BossToolsModElements instance) {
		super(instance, 603);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY9Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
