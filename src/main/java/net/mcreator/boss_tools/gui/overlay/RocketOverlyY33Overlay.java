...
import net.mcreator.boss_tools.procedures.RocketY33Procedure;
...
public class RocketOverlyY33Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY33Overlay(BossToolsModElements instance) {
		super(instance, 632);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY33Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
