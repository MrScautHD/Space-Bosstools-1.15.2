...
import net.mcreator.boss_tools.procedures.RocketY10Procedure;
...
public class RocketOverlyY10Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY10Overlay(BossToolsModElements instance) {
		super(instance, 604);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY10Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
