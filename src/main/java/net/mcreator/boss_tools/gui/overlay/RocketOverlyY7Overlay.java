...
import net.mcreator.boss_tools.procedures.RocketY7Procedure;
...
public class RocketOverlyY7Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY7Overlay(BossToolsModElements instance) {
		super(instance, 601);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY7Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
