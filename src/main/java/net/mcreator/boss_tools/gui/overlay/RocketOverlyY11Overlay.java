...
import net.mcreator.boss_tools.procedures.RocketY11Procedure;
...
public class RocketOverlyY11Overlay extends BossToolsModElements.ModElement {
	public RocketOverlyY11Overlay(BossToolsModElements instance) {
		super(instance, 605);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (RocketY11Procedure.executeProcedure(ImmutableMap.of("entity", entity))) {
