...
public class NasaWorkbenchGui extends BossToolsModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 123, this.guiTop + 63, 0, 0, 256, 256, 256, 256);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("boss_tools:textures/nasapfeil.png"));
			this.blit(this.guiLeft + 104, this.guiTop + 45, 0, 0, 256, 256, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("NASA Workbench", 6, 5, -13421773);
			this.font.drawString("Inventory", 8, 127, -13421773);
		}
