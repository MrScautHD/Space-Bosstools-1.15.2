...
public class RocketmoonGuiGui extends BossToolsModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 140, this.guiTop + 186, 0, 0, 256, 256, 256, 256);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 254, this.guiTop + 192, 37, 20, "Orbit", e -> {
				BossToolsMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
				handleButtonAction(entity, 0, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 254, this.guiTop + 231, 37, 20, "Orbit", e -> {
				BossToolsMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(1, x, y, z));
				handleButtonAction(entity, 1, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 175, this.guiTop + 231, 75, 20, "Moon", e -> {
			...
			this.addButton(new Button(this.guiLeft + 175, this.guiTop + 192, 75, 20, "Overworld", e -> {
				BossToolsMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(4, x, y, z));
				handleButtonAction(entity, 4, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 295, this.guiTop + 192, 76, 20, "Space Station", e -> {
